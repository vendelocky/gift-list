# ALCHEMY UNIVERSITY ASSIGNMENT - WEEK 2
...
After running the application, there is a function to enter a name in the terminal. Once a name is entered, the result will be displayed in terminal.
